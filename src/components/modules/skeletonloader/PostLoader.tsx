...
export const PostLoader = (): React.JSX.Element => {
    ...
    return (
        ...
        >
            ...
            <div>
                <div className=" w-[600px] tabletS:w-[400px] mobileXL:w-[300px] mobileL:w-[250px] bg-gray-300 animate-pulse h-8 mb-2"></div>
                <div className=" w-[600px] tabletS:w-[400px] mobileXL:w-[300px] mobileL:w-[250px] bg-gray-300 animate-pulse h-8 mb-2"></div>
            ...
            <div className=" w-[600px] tabletS:w-[400px] mobileXL:w-[300px] mobileL:w-[250px] h-[250px] bg-gray-300 animate-pulse mb-2"></div>
        </div>
    );
};
